const supersetupDefaultPage = `<script>
  import { onMount } from 'svelte';
  import { Github, Terminal, Star, Package } from 'lucide-svelte';
    ...
    <div class="max-w-5xl w-full">
      ...
      <div class="transition-all duration-700 delay-200 {mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}">
        ...
        <div class="grid grid-cols-7 gap-4 max-w-3xl mx-auto">
          {#each frameworks as fw, idx}
            <div
              class="bg-gray-900 border {fw.borderColor} rounded-lg p-4 hover:bg-gray-800 transition-all hover:scale-105 cursor-default group"
            >
